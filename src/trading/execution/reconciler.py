...
class Reconciler:
    ...
    TODO(phase-6): Extend to wallet/position reconciliation and auto-healing actions.
    """

    def __init__(self, *, rest_client: BybitRestClient, order_manager: OrderManager, category: str) -> None:
